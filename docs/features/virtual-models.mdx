...
returns `409 Conflict` with an explanation of what references it. A **force
delete** (`force: true` in the admin API or the corresponding dashboard action)
bypasses the guard and removes the alias regardless of outstanding
authorizations.
